...
export const sketches: SketchEntry[] = [
    ...
    meta: {
      ...
      description: "Composición generativa: un patrón aleatorio de líneas que recorre y se acumula sobre el lienzo, una cuadrícula de elipses y un cuadrado central que gira. Loop continuo, interactivo por mouse.",
      tags: ["generativo", "líneas", "cuadrícula", "interactivo"],
      controls: [
        { key: "mouse", action: "Mantener pulsado cambia el color de líneas y formas." },
        { key: "s / f", action: "Guardar el canvas como PNG (saveCanvas)." },
      ],
      needsAudio: false,
      width: 600,
      height: 600,
  ...
  },
  {
    meta: {
      ...
      description: "Campo de flujo de ruido Perlin (Coding Train): 300 partículas siguen el campo recalculado cada frame y dejan estelas de color que derivan en el tiempo y rebotan en los bordes. Reusa la biblioteca Particle extendida con el modo 'estela'.",
      tags: ["partículas", "flow field", "Perlin noise", "estela", "bibliotecas"],
      controls: [
  ...
  },
  {
    meta: {
      ...
      description: "Flor animada de cuatro capas de espirales (centro, corona, semillas y pétalos) que respiran: los radios y ciclos hacen ping-pong entre límites mientras los offsets de ángulo rotan en sentidos contrarios. Reusa la biblioteca Spiral en modo instancia.",
  ...
  },
   {
    ...
    meta: {
      ...
      description: "Rejilla dibujada con bucles anidados: cada celda tiene un círculo en trayectoria circular (cos/sin) y una elipse cuyo verde se modula con ruido Perlin. El fondo no se limpia, por lo que el movimiento deja rastros que tejen una textura tipo campo.",
      tags: ["rejilla", "Perlin noise", "movimiento circular", "rastro"],
      controls: [
        { key: "s", action: "Guardar el canvas como PNG (saveCanvas)." },
      ],
      needsAudio: false,
  ...
  },
  {
    meta: {
      ...
      description: "Rejilla de figuras dibujadas con bucles anidados: en cada celda un punto blanco, un aro azul y un cuadrado rojo que laten al unísono. Los tamaños hacen ping-pong, produciendo el pulso. Loop continuo.",
      tags: ["rejilla", "geometría", "pulso", "loop anidado"],
      controls: [
        { key: "s", action: "Guardar el canvas como PNG (saveCanvas)." },
      ],
      needsAudio: false,
  ...
  },
  {
    meta: {
      ...
      description: "Tres bolitas con posición y velocidad como vectores rebotan dentro de una frontera rectangular, invirtiendo su velocidad al tocar el borde. Ejercicio de vectores del taller de mndrn.mx.",
      tags: ["partículas", "rebote", "vectores", "interactivo"],
      controls: [
    ...
    meta: {
      ...
      description: "Reimplementación en p5 del clásico canvas shooter: el jugador está al centro, clic para disparar hacia el cursor; los enemigos surgen de los bordes y lo persiguen, al impactarlos encogen o explotan en partículas y suman score. El original era Canvas 2D vanilla + gsap; aquí se reescribe sobre p5 sin dependencias externas.",
      tags: ["juego", "interactivo", "colisiones", "partículas"],
      controls: [
        {
          key: "clic",
  ...
  },
  {
    meta: {
      ...
      description: "Círculos cuyos diámetros crecen en proporción áurea (φ = 1.618) anclados a las esquinas y retículas de una rejilla, con un cuadrado central que rota. Estudio de composición geométrica; loop continuo.",
      tags: ["proporción áurea", "geometría", "composición"],
  ...
  },
  {
    meta: {
      ...
      description: "Una línea cuyo extremo orbita el centro sobre un fondo negro persistente; el grosor y la opacidad del trazo se modulan con ruido Perlin, dejando una estela orgánica que rellena el círculo. El 'hola mundo' más compacto del wrapper.",
  ...
  },
  {
    meta: {
      ...
      description: "Relieve de montaña generativo (vertical) trazado por una trayectoria circular con ruido a lo largo de una franja temporal. Termina con noLoop().",
      tags: ["timeline", "relieve", "Perlin noise", "noLoop"],
      controls: [{ key: "s", action: "Guardar el canvas como PNG (saveCanvas)." }],
      needsAudio: false,
      width: 1080,
      height: 1350,
  ...
  },
  {
    meta: {
      ...
      description: "Paisaje radial trazado en HSB: dos ángulos contrarrotantes tejen líneas desde el centro, moduladas por ruido Perlin. La pieza es de duración fija: al completar una vuelta (angle ≥ TWO_PI) dibuja un remate de cuadrados y se detiene con noLoop().",
  ...
  },  
  {
    meta: {
      ...
      description: "Variante coloreada de Revolution en HSB con paleta verde/vino: dos ángulos contrarrotantes tejen líneas moduladas por ruido y, al cerrar la vuelta, rematan con una franja de líneas. Termina con noLoop().",
      tags: ["radial", "HSB", "Perlin noise", "noLoop"],
      controls: [{ key: "s", action: "Guardar el canvas como PNG (saveCanvas)." }],
      needsAudio: false,
      width: 1000,
  ...
  },
  {
    meta: {
      ...
      description:  "Pieza de timeline (≈30 s) por millis(): un atardecer de círculos concéntricos da paso a un rayo de luz y a un relieve trazado con ruido, y se detiene con noLoop(). Composición vertical.",
      tags: ["timeline", "atardecer", "HSB", "noLoop"],
      controls: [{ key: "s", action: "Guardar el canvas como PNG (saveCanvas)." }],
      needsAudio: false,
      width: 800,
      height: 1000,
  ...
  },
  {
    meta: {
      ...
      description: "Atardecer generativo en formato vertical (Instagram): degradado de sol y cielo por círculos interpolados (lerpColor) más rayos de luz que brotan del horizonte, animados por ruido sobre un timeline que termina con noLoop().",
      tags: ["timeline", "atardecer", "RGB", "lerpColor"],
      controls: [{ key: "s", action: "Guardar el canvas como PNG (saveCanvas)." }],
      needsAudio: false,
      width: 1080,
      height: 1350,
